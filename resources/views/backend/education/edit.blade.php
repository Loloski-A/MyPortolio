...
<main class="app-main">
    ...
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Edit Education Journey Page</h3>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="cart-header mb-3 p-3 bg-info">
                            <h3 class="card-title ">Edit Your Education Journey</h3>
                        </div>

                        <form action="{{ url('admin/education/post/'.$educationRecord->id) }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    value={{ @$educationRecord->started_date }}>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    value={{ @$educationRecord->end_date }}>
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ url('admin/education') }}" class="btn btn-default float-right">
                                    Cancel
                                </a>
                            </div>
