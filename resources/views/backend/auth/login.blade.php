...
<head>
    ...
    <title>Personal Portfolio Website | Log in</title><!--begin::Primary Meta Tags-->
...
<body class="login-page bg-body-secondary">
    ...
    <script src="{{ url('public/backend/dist/js/adminlte.js')}}"></script> <!--end::Required Plugin(AdminLTE)-->
