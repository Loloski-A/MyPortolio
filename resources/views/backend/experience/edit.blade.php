...
<main class="app-main">
    ...
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Edit Your Experience Page</h3>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form action="{{ url('admin/experience/post/'.$experienceRecord->id) }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    class="form-control" placeholder="Enter Your Role in the Company"
                                    value={{ @$experienceRecord->role }}>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    value={{ @$experienceRecord->started_date }}>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    value={{ @$experienceRecord->end_date }}>
                                </div>
                            </div>
